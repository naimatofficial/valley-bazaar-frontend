...
const deliveryBoyChats = [
  { name: 'Delivery Boy 1', lastMessage: 'On my way', details: 'Details of Delivery Boy 1' },
  { name: 'Delivery Boy 2', lastMessage: 'Delivered', details: 'Details of Delivery Boy 2' }
];
...
const Inbox = () => {
  ...
  return (
    <div className="bg-white text-sm md:text-base h-screen mx-auto shadow-md rounded-lg flex flex-col md:flex-row">
    <div className="md:w-1/3 w-full bg-green-50 p-4 rounded-l-lg md:rounded-r-none">
    ...
    <div className="md:w-2/3 w-full md:ml-5 mt-5 md:mt-0  rounded-l-none p-4">
      {selectedChat ? (
        ...
        <p className="r text-gray-600 text-center">Select a chat to see details</p>
      )}
    </div>
  </div>
  );
