        ...
        <div className="mb-6">
          <label className="flex flex-row  rounded-lg p-4 mb-4 cursor-pointer hover:bg-gray-50">
            ...
            <span className="flex items-center">
              <img src="https://via.placeholder.com/24" alt="Cash on Delivery" className="mr-2" />
              Cash on Delivery
            </span>
          </label>
          <div className="mb-4">
            <p className="text-lg font-medium">Pay Via Online <span className="text-sm text-gray-500">(Faster & Secure Way To Pay)</span></p>
            <div className="grid grid-cols-2 gap-4 mt-2">
              <label className="flex flex-row  rounded-lg p-4 cursor-pointer hover:bg-gray-50">
                <input type="radio" name="payment" className="mr-3" />
                <span className="flex items-center">
                  <img src="https://via.placeholder.com/24" alt="Paypal" className="mr-2" />
                  Paypal
                </span>
              </label>
              <label className="flex flex-row  rounded-lg p-4 cursor-pointer hover:bg-gray-50">
                <input type="radio" name="payment" className="mr-3" />
                <span className="flex items-center">
                  <img src="https://via.placeholder.com/24" alt="Stripe" className="mr-2" />
                  Stripe
                </span>
              </label>
              <label className="flex flex-row  rounded-lg p-4 cursor-pointer hover:bg-gray-50">
                <input type="radio" name="payment" className="mr-3" />
                <span className="flex items-center">
                  <img src="https://via.placeholder.com/24" alt="Razor Pay" className="mr-2" />
                  Razor Pay
                </span>
              </label>
              <label className="flex flex-row  rounded-lg p-4 cursor-pointer hover:bg-gray-50">
                <input type="radio" name="payment" className="mr-3" />
                <span className="flex items-center">
                  <img src="https://via.placeholder.com/24" alt="Ssl Commerz" className="mr-2" />
                  Ssl Commerz
                </span>
              </label>
            </div>
